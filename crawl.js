...
server.get('/search/:name', function (_a, res) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, nightmare.goto(baseUrl)];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, nightmare.wait()];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, nightmare.type('.search .ac-input', name)];
                case 3:
                    _b.sent();
...
server.listen(3000, function () { return console.log('Started sever on port 3000.'); });
